 ...
 ***FOR BEST RESULTS USE GEMINI 2.5 PRO (MY PERSONAL FAVORITE) AND GROK 3.0. CHATGPT 4.5 AND GROK 4 BOTH ARE SUPERIOR AT CERTAIN SPECIALIZED REASONING TASKS SUCH AS NARRATIVE AND ARC AGI SOLVER RESPECTIVELY, HOWEVER THEY BOTH BUT LACK THE TOKEN OUTPUT DEPTH NEEDED FOR FULL CANVAS AUDITABILITY, WHICH ALSO SIGNIFICANTLY EFFECTS REASONING CAPABILITIES. IF IT DOESN'T EXPLAIN ITS WORK... THEN IT ISN'T WELL REASONED, EVEN IF IT IS CORRECT. HOPEFULLY THEY REMEDY THIS FOR COGNITIVE REASONING PROMPTS.***
